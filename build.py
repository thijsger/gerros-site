...
NAV_ITEMS = [('apps.html', 'Apps'), ('finder.html', 'Find your app'), ('whatsnew.html', "What's new"), ('wearos.html', 'Wear OS'), ('studio.html', 'Studio'), ('support.html', 'Support')]
...
single = re.sub(r'href="((?:\.\./)?)((?:apps/[a-z0-9-]+|index|apps|finder|whatsnew|wearos|studio|support|privacy)\.html)(#[a-z]+)?"',
